        ...
        startTransition(async () => {
            ...
            if (result.success) {
                toast.success("Recebimento Confirmado!", {
                    description: "O recibo digital foi gerado e o item agora consta em sua carga."
                });
                router.refresh();
            } else {
        ...
        <Card className="border-l-4 border-l-blue-500 shadow-sm relative overflow-hidden">
            ...
            <CardContent className="space-y-4">
                ...
                <p className="text-xs text-muted-foreground">
                    Enviado em: {transfer.createdAt ? new Date(transfer.createdAt).toLocaleDateString() : "-"}
                </p>
            </CardContent>
            <CardFooter className="flex justify-end gap-3 pt-2 relative z-10">
                ...
                >
                    ...
                    {isPending ? "Assinando..." : "Assinar e Receber"}
                </Button>
            </CardFooter>
        </Card>
    );
